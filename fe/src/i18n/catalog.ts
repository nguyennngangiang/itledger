...
export const EN = {
  ...
  "hi.pick.hint":
    "Excel, PDF or a photo of a handover record. The AI reads the fields; the direction is worked out from the ledger's own history.",
  ...
  "hi.flow.issue": "Handed out",
  "hi.flow.transfer": "Between two people",
  "hi.flow.flip": "Flip direction",
  "hi.flow.skip": "Skip",
  "hi.flow.unskip": "Import this row after all",
  "hi.row.skipped": "Row skipped",
  "hi.row.confirm": "needs confirming",
  "hi.row.confirmTip": "The system is not sure — please confirm",
  "hi.row.header": "No. {no}",
  "hi.row.effect": "{from} → {to} · device becomes {owner}, status {status}",
  ...
  "hi.it.knownSide": "{reason} — the direction is worked out per row; flip any that are wrong.",
  "hi.it.unknownSide":
  ...
  "iq.status.detecting": "working out what it is…",
